  ...
  return (
    ...
    <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8"> {/* Changed to md:grid-cols-2 */}
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Better understanding of regulations such as R638, OHSA, NEMWA, and local by-laws, including practical experience.  
              </p>
            </div>
            <div className="text-center">
